...
(	course varchar(300) NOT NULL PRIMARY KEY,
    ...
    exam_start varchar(5) NOT NULL,
    exam_end varchar(5) NOT NULL
);
...
LOAD DATA LOCAL INFILE 'd:/spm-data/student.csv' INTO TABLE student
FIELDS TERMINATED BY ',' 
LINES TERMINATED BY '\r\n' 
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'd:/spm-data/course.txt' INTO TABLE course
FIELDS TERMINATED BY '\t' 
LINES TERMINATED BY '\r\n' 
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'd:/spm-data/course_completed.csv' INTO TABLE course_completed
FIELDS TERMINATED BY ',' 
LINES TERMINATED BY '\r\n' 
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'd:/spm-data/prerequisite.csv' INTO TABLE prerequisite
FIELDS TERMINATED BY ',' 
LINES TERMINATED BY '\r\n' 
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'd:/spm-data/section.csv' INTO TABLE section
FIELDS TERMINATED BY ',' 
LINES TERMINATED BY '\r\n' 
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'd:/spm-data/bid.csv' INTO TABLE bid
FIELDS TERMINATED BY ',' 
LINES TERMINATED BY '\r\n' 
IGNORE 1 LINES;